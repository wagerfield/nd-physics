describe('NDP.Vector2', function() {
  ...
  describe('squaredLength(vector)', function() {
    ...
    it('should return [vector][n] * [vector][n]', function() {
      expect(NDP.Vector2.squaredLength(this.a)).toEqual(squaredLength(this.a));
      expect(NDP.Vector2.squaredLength(this.b)).toEqual(squaredLength(this.b));
      expect(NDP.Vector2.squaredLength(this.c)).toEqual(squaredLength(this.c));
    });
  });
  ...
  describe('length(vector)', function() {
    ...
    it('should return Math.sqrt([vector][n] * [vector][n])', function() {
      expect(NDP.Vector2.length(this.a)).toEqual(length(this.a));
      expect(NDP.Vector2.length(this.b)).toEqual(length(this.b));
      expect(NDP.Vector2.length(this.c)).toEqual(length(this.c));
    });
  });
