describe('NDP.TimeCorrectedVerletIntegrator(opt_dimensions)', function() {
  ...
  beforeEach(function() {
    ...
    this.integrate = function(force, delta, lubricity) {
      ...
      if (this.delta === null) this.delta = delta;
      ...
      // deltaCorrection = delta(i) / delta(i-1)
      this.deltaCorrection = delta / this.delta;
      this.delta = delta;
      ...
      this.vector.scale(this.vel, this.vel, this.deltaCorrection);
  ...
  describe('integrate(particles, delta, lubricity)', function() {
    it('should integrate motion using Time Corrected Verlet integration', function() {
